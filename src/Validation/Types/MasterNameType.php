...
/**
 * Validates MasterName property.
 *
 * @link https://www.w3.org/TR/xsl11/#master-name
 */
class MasterNameType extends Type implements DataAwareValidator
{
    ...
    {
        // A master-name must comply with NCName
        ...
        if ($root === null) {
            throw new ValidationException('MasterNameType needs root context to validate value.');
        }
