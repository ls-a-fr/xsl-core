...
/**
 * A signed real percentage which consists of an optional
 * '+' or '-' character followed by a sequence of digits
 ...
 */
class PercentageType extends Type implements Validator
{
