 ...
 */
class InlineProgressionDimensionOptimumType extends Type implements Validator
{
    /**
     * A value of "auto" may be specified for optimum, indicating that there is no preferred dimension,
     * but that the intrinsic or resolved dimension of the area should be used. If minimum and/or maximum
     * are not also auto, then the dimension shall be constrained between those limits.
     */
