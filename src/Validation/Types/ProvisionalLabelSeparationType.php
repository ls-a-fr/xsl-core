...
/**
 * Validates ProvisionalLabelSeparation property.
 *
 * `<length>`:
 * - The "provisional-label-separation" is specified as a length.
 *
 * `<percentage>`:
 * - The "provisional-label-separation" is specified as a percentage of the inline-progression-dimension of
 * - the closest ancestor block-area.
 *
 * @link https://www.w3.org/TR/xsl/#provisional-label-separation
 */
class ProvisionalLabelSeparationType extends Type implements Validator
{
