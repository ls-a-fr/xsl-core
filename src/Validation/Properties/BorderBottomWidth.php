 ...
 *
 * @link https://www.w3.org/TR/xsl11/#border-bottom-width
 * @link https://www.w3.org/TR/xsl11/#border-top-width
 * @link http://www.w3.org/TR/REC-CSS2/box.html#propdef-border-bottom-width
 */
class BorderBottomWidth extends TypedAttribute implements HasDefaultValue
{
    public function __construct()
    {
        parent::__construct('border-bottom-width', BorderWidthType::class);
    }
