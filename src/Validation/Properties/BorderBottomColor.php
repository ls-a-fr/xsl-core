 ...
 *
 * @link https://www.w3.org/TR/xsl11/#border-bottom-color
 * @link https://www.w3.org/TR/xsl11/#border-top-color
 *
 * @linkhttp://www.w3.org/TR/REC-CSS2/box.html#propdef-border-bottom-color
 */
class BorderBottomColor extends SingleColor implements HasDefaultValueWithContext
{
    public function __construct()
    {
        parent::__construct('border-bottom-color', BorderColorType::class);
    }
}
