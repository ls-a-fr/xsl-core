 ...
 * - Media: visual
 *
 * A shorthand property for setting the width, style, and color of the bottom border of a block-area or
 * inline-area.
 *
 * @link http://www.w3.org/TR/REC-CSS2/box.html#propdef-border-bottom
 */
class BorderBottom extends ShorthandTypedAttribute
{
