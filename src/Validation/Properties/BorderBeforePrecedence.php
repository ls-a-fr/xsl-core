 ...
 * (and the likes).
 *
 * @link https://www.w3.org/TR/xsl11/#border-before-precedence
 */
class BorderBeforePrecedence extends BorderPrecedence implements HasDefaultValueWithContext
{
    public function __construct()
    {
        parent::__construct('border-before-precedence', BorderPrecedenceType::class);
    }
}
