 ...
 *
 * @link https://www.w3.org/TR/xsl11/#border-left-style
 * @link https://www.w3.org/TR/xsl11/#border-top-style
 * @link http://www.w3.org/TR/REC-CSS2/box.html#propdef-border-left-style
 */
class BorderLeftStyle extends TypedAttribute implements HasDefaultValue
{
    public function __construct()
    {
        parent::__construct('border-left-style', BorderStyleType::class);
    }
