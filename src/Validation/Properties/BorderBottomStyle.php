 ...
 *
 * @link https://www.w3.org/TR/xsl11/#border-bottom-style
 * @link https://www.w3.org/TR/xsl11/#border-top-style
 * @link http://www.w3.org/TR/REC-CSS2/box.html#propdef-border-bottom-style
 */
class BorderBottomStyle extends TypedAttribute implements HasDefaultValue
{
    public function __construct()
    {
        parent::__construct('border-bottom-style', BorderStyleType::class);
    }
