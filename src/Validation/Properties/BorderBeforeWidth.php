 ...
 *
 * @link https://www.w3.org/TR/xsl11/#border-before-width
 * @link https://www.w3.org/TR/xsl11/#border-top-width
 */
class BorderBeforeWidth extends CompoundTypedAttribute implements HasDefaultValue
{
    public function __construct()
    {
        parent::__construct('border-before-width', BorderRelativeWidthType::class, [
