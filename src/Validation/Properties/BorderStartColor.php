 ...
 *
 * @link https://www.w3.org/TR/xsl11/#border-start-color
 * @link https://www.w3.org/TR/xsl11/#border-top-color
 */
class BorderStartColor extends SingleColor implements HasDefaultValueWithContext
{
    public function __construct()
    {
        parent::__construct('border-start-color', BorderColorType::class);
    }
}
