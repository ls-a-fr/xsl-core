 ...
 *
 * @link https://www.w3.org/TR/xsl11/#border-before-color
 * @link https://www.w3.org/TR/xsl11/#border-top-color
 */
class BorderBeforeColor extends SingleColor implements HasDefaultValueWithContext
{
    public function __construct()
    {
        parent::__construct('border-before-color', BorderColorType::class);
    }
}
