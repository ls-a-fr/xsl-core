 ...
 * (and the likes).
 *
 * @link https://www.w3.org/TR/xsl11/#border-end-precedence
 */
class BorderEndPrecedence extends BorderPrecedence implements HasDefaultValueWithContext
{
    public function __construct()
    {
        parent::__construct('border-end-precedence', BorderPrecedenceType::class);
    }
}
