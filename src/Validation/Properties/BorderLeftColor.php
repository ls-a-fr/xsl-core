 ...
 *
 * @link https://www.w3.org/TR/xsl11/#border-left-color
 * @link https://www.w3.org/TR/xsl11/#border-top-color
 *
 * @linkhttp://www.w3.org/TR/REC-CSS2/box.html#propdef-border-left-color
 */
class BorderLeftColor extends SingleColor implements HasDefaultValueWithContext
{
    public function __construct()
    {
        parent::__construct('border-left-color', BorderColorType::class);
    }
}
