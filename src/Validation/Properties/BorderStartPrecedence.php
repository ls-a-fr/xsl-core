 ...
 * (and the likes).
 *
 * @link https://www.w3.org/TR/xsl11/#border-start-precedence
 */
class BorderStartPrecedence extends BorderPrecedence implements HasDefaultValueWithContext
{
    public function __construct()
    {
        parent::__construct('border-start-precedence', BorderPrecedenceType::class);
    }
}
