 ...
 *
 * @link https://www.w3.org/TR/xsl11/#border-left-width
 * @link https://www.w3.org/TR/xsl11/#border-top-width
 * @link http://www.w3.org/TR/REC-CSS2/box.html#propdef-border-left-width
 */
class BorderLeftWidth extends TypedAttribute implements HasDefaultValue
{
    public function __construct()
    {
        parent::__construct('border-left-width', BorderWidthType::class);
    }
