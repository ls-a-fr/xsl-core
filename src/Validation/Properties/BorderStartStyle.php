 ...
 *
 * @link https://www.w3.org/TR/xsl11/#border-start-style
 * @link https://www.w3.org/TR/xsl11/#border-top-style
 */
class BorderStartStyle extends TypedAttribute implements HasDefaultValue
{
    public function __construct()
    {
        parent::__construct('border-start-style', BorderStyleType::class);
    }
