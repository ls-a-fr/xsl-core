...
use Lsa\Xsl\Core\Validation\Types\PageWidthType;
 ...
 *
 * @link https://www.w3.org/TR/xsl/#page-width
 */
class PageWidth extends TypedAttribute implements HasDefaultValue
{
    public function __construct()
    {
        parent::__construct('page-width', PageWidthType::class);
    }

    public function getDefaultValue(): string
    {
        return PageWidthType::AUTO;
    }
}
