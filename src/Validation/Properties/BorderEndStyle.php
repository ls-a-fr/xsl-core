 ...
 *
 * @link https://www.w3.org/TR/xsl11/#border-end-style
 * @link https://www.w3.org/TR/xsl11/#border-top-style
 */
class BorderEndStyle extends TypedAttribute implements HasDefaultValue
{
    public function __construct()
    {
        parent::__construct('border-end-style', BorderStyleType::class);
    }
