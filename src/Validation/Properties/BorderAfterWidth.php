 ...
 *
 * @link https://www.w3.org/TR/xsl11/#border-after-width
 * @link https://www.w3.org/TR/xsl11/#border-top-width
 */
class BorderAfterWidth extends CompoundTypedAttribute implements HasDefaultValue
{
    public function __construct()
    {
        parent::__construct('border-after-width', BorderRelativeWidthType::class, [
