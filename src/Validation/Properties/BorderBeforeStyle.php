 ...
 *
 * @link https://www.w3.org/TR/xsl11/#border-before-style
 * @link https://www.w3.org/TR/xsl11/#border-top-style
 */
class BorderBeforeStyle extends TypedAttribute implements HasDefaultValue
{
    public function __construct()
    {
        parent::__construct('border-before-style', BorderStyleType::class);
    }
