 ...
 *
 * @link https://www.w3.org/TR/xsl11/#border-start-width
 * @link https://www.w3.org/TR/xsl11/#border-top-width
 */
class BorderStartWidth extends CompoundTypedAttribute implements HasDefaultValue
{
    public function __construct()
    {
        parent::__construct('border-start-width', BorderRelativeWidthType::class, [
