...
use Lsa\Xsl\Core\Validation\Types\ElevationType as TypesElevationType;
...
class ElevationType extends Type implements Validator
{
    ...
    public function getValidator(): Validator
    {
        return new EnumValidator([
            TypesElevationType::BELOW,
            TypesElevationType::LEVEL,
            TypesElevationType::ABOVE,
            TypesElevationType::HIGHER,
            TypesElevationType::LOWER,
