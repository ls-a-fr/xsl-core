...
use Lsa\Xsl\Core\Xsd\Fop\Types\MarginWidthType;
 ...
 *
 * Handling for both fo:auto_Type and fo:inherit_Type
 */
class AutoInheritTransformer extends UnionTransformer
{
    public function appliesTo(object $object): bool
    {
        return $object instanceof Union &&
            in_array(get_class($object->validator), [
                BottomType::class,
                LeftType::class,
                MarginWidthType::class,
                PlayDuringType::class,
                RightType::class,
                ScriptType::class,
                TopType::class,
                ZIndexType::class,
