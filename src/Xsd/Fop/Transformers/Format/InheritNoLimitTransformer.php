...
use Lsa\Xsl\Core\Xsd\Fop\Types\NoLimitType;
 ...
 *
 * Handling for both fo:inherit_Type and fo:no_limit_Type
 */
class InheritNoLimitTransformer extends UnionTransformer
{
