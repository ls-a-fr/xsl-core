...
use Lsa\Xsl\Core\Xsd\Fop\Types\NoneType;
 ...
 *
 * Handling for both fo:inherit_Type and fo:none_Type
 */
class InheritNoneTransformer extends UnionTransformer
{
    public function appliesTo(object $object): bool
    {
        return $object instanceof Union &&
            in_array(get_class($object->validator), [
                FontSizeAdjustType::class,
