...
use Lsa\Xsl\Core\Validation\Tags\RegionEnd as ValidateRegionEnd;
use Lsa\Xsl\Core\Xml\Tag;

/**
 * Used in constructing a simple-page-master. This region specifies a viewport/reference pair that is located
 * on the "end" side of the page-reference-area. In lr-tb writing-mode, this region corresponds to a right
 ...
 *
 * Areas:
 * The fo:region-end formatting object is used to generate one region-viewport-area and one
 * region-reference-area.
 * The values of the padding and border-width traits must be "0".
 * The end-edge of the content-rectangle of this region-viewport-area is positioned coincident with the
 * end-edge of the content-rectangle of the page-reference-area generated using the parent fo:simple-page-master.
 * The inline-progression-dimension of the region-viewport-area is determined by the extent trait on the
 * fo:region-end formatting object.
 ...
 * region-end acts like a float into areas generated by the region-before (respectively, the region-after).
 * If the value of the precedence trait on the adjacent regions is true, then these adjacent regions float
 * into the area generated by the fo:region-end and the extent of the fo:region-end is (effectively) reduced
 * by the incursions of the adjacent regions with the value of the precedence trait equal to true.
 ...
 *
 * Constraints:
 * The constraints on the size and position of the region-reference-area generated using the fo:region-end are
 ...
 * Contents:
 * EMPTY
 * @see https://www.w3.org/TR/xsl11/#fo_region-end
 */
class RegionEnd extends Tag implements HasAuralFallback, HasVisualFallback
{
    use ExtendedAuralConformance;
    use ExtendedVisualConformance;
    use ValidateRegionEnd;
