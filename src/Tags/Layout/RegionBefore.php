...
use Lsa\Xsl\Core\Validation\Tags\RegionBefore as ValidateRegionBefore;
use Lsa\Xsl\Core\Xml\Tag;

/**
 * Used in constructing a simple-page-master. This region specifies a viewport/reference pair that is located
 * on the "before" side of the page-reference-area. In lr-tb writing-mode, this region corresponds to the
 * header region. The overflow trait controls how much of the underlying region-reference-area is visible;
 * that is, whether the region-reference-area is clipped by its parent region-viewport-area.
 *
 * Areas:
 * The fo:region-before formatting object is used to generate one region-viewport-area and one
 * region-reference-area.
 * The values of the padding and border-width traits must be "0".
 * The before-edge of the content-rectangle of this region-viewport-area is positioned coincident with the
 * before-edge of the content-rectangle of the page-reference-area generated using the parent
 ...
 * fo:region-before. If the value of the precedence trait is true, then the inline-progression-dimension
 * extends up to the start-edge and end-edge of the content-rectangle of the page-reference-area. In this
 * case, the region-before region-viewport-area acts like a float into areas generated by the region-start and
 * region-end. If the value of the precedence trait on the fo:region-before is false, then these adjacent
 * regions float into the area generated by the fo:region-before and the extent of the fo:region-before is
 ...
 *
 * Constraints:
 * The constraints on the size and position of the region-reference-area generated using the fo:region-before
 ...
 * Contents:
 * EMPTY
 * @see https://www.w3.org/TR/xsl11/#fo_region-before
 */
class RegionBefore extends Tag implements HasAuralFallback, HasVisualFallback
{
    use ExtendedAuralConformance;
    use ExtendedVisualConformance;
    use ValidateRegionBefore;
