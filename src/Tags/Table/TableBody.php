...
use Lsa\Xsl\Core\Validation\Tags\TableBody as ValidateTableBody;
 ...
 *
 * Areas:
 * The fo:table-body formatting object does not generate any areas. The fo:table-body formatting object
 * returns the sequence of areas created by concatenating the sequences of areas returned by each of the
 * children of the fo:table-body.
 *
 * Constraints:
 * The order of concatenation of the sequences of areas returned by the children of the fo:table-body is the
 * same order as the children are ordered under the fo:table-body.
 *
 * Contents:
 * (table-row+|table-cell+)
 *
 * The fo:table-body has fo:table-row (one or more) as its children, or alternatively fo:table-cell (one or
