...
final class TableColumnTest extends CommonMethodsFop
{
    public function test_schema(): void
    {
        $comparator = new XmlComparator(XmlComparator::VALIDATION_STRICT);
        $xsd = self::$xsdElement->xpath('/x:schema/x:element[@name="table-column"]');
        $fop = self::$fopElement->xpath('/x:schema/x:element[@name="table-column"]');
    ...
    {
        $tag1 = (new TableColumn())->asDefinition();
        $tag2 = (new FopProfile())->check(new TableColumn())->asDefinition();
