...
final class RegionEndTest extends CommonMethodsFop
{
    public function test_schema(): void
    {
        $comparator = new XmlComparator(XmlComparator::VALIDATION_STRICT);
        $xsd = self::$xsdElement->xpath('/x:schema/x:element[@name="region-end"]');
        $fop = self::$fopElement->xpath('/x:schema/x:element[@name="region-end"]');
    ...
    {
        $tag1 = (new RegionEnd())->asDefinition();
        $tag2 = (new FopProfile())->check(new RegionEnd())->asDefinition();
