...
final class PageSequenceTest extends CommonMethodsFop
{
    public function test_schema(): void
    {
        $comparator = new XmlComparator(XmlComparator::VALIDATION_STRICT);
        $xsd = self::$xsdElement->xpath('/x:schema/x:element[@name="page-sequence"]');
        $fop = self::$fopElement->xpath('/x:schema/x:element[@name="page-sequence"]');
    ...
    {
        $tag1 = (new PageSequence())->asDefinition();
        $tag2 = (new FopProfile())->check(new PageSequence())->asDefinition();
