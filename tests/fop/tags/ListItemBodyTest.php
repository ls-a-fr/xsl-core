...
final class ListItemBodyTest extends CommonMethodsFop
{
    public function test_schema(): void
    {
        $comparator = new XmlComparator(XmlComparator::VALIDATION_STRICT);
        $xsd = self::$xsdElement->xpath('/x:schema/x:element[@name="list-item-body"]');
        $fop = self::$fopElement->xpath('/x:schema/x:element[@name="list-item-body"]');
    ...
    {
        $tag1 = (new ListItemBody())->asDefinition();
        $tag2 = (new FopProfile())->check(new ListItemBody())->asDefinition();
