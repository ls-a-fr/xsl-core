...
final class BlockPropertiesTest extends CommonMethodsFop
{
    public function test_schema(): void
    {
        $comparator = new XmlComparator(XmlComparator::VALIDATION_STRICT);
        $xsd = self::$xsdElement->xpath('/x:schema/x:attributeGroup[@name="block_properties"]');
        $fop = self::$fopElement->xpath('/x:schema/x:attributeGroup[@name="block_properties"]');
