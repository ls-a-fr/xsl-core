...
final class IntrusionDisplacePropertiesListFopTest extends CommonMethodsFop
{
    public function test_schema(): void
    {
        $comparator = new XmlComparator(XmlComparator::VALIDATION_STRICT);
        $xsd = self::$xsdElement->xpath('/x:schema/x:attributeGroup[@name="intrusion_displace_Properties_List_FOP"]');
        $fop = self::$fopElement->xpath('/x:schema/x:attributeGroup[@name="intrusion_displace_Properties_List_FOP"]');
