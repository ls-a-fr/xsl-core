...
use Lsa\Xsl\Core\Tests\Providers\SystemColorFunctionDataProvider;
use Lsa\Xsl\Core\Tokenizer\Computing\XslTokenParser;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class SystemColorFunctionTest extends CommonMethods
{
    #[DataProviderExternal(SystemColorFunctionDataProvider::class, 'validDataProvider')]
    ...
    #[DataProviderExternal(SystemColorFunctionDataProvider::class, 'invalidDataProvider')]
