...
use Lsa\Xsl\Core\Tests\Providers\BodyStartFunctionDataProvider;
use Lsa\Xsl\Core\Tokenizer\Computing\XslTokenParser;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class BodyStartFunctionTest extends CommonMethods
{
    #[DataProviderExternal(BodyStartFunctionDataProvider::class, 'validDataProvider')]
    ...
    #[DataProviderExternal(BodyStartFunctionDataProvider::class, 'invalidDataProvider')]
