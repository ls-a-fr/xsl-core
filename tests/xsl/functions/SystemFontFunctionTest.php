...
use Lsa\Xsl\Core\Tests\Providers\SystemFontFunctionDataProvider;
use Lsa\Xsl\Core\Tokenizer\Computing\XslTokenParser;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class SystemFontFunctionTest extends CommonMethods
{
    #[DataProviderExternal(SystemFontFunctionDataProvider::class, 'validDataProvider')]
    ...
    #[DataProviderExternal(SystemFontFunctionDataProvider::class, 'invalidDataProvider')]
