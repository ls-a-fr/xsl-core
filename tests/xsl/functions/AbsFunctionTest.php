...
use Lsa\Xsl\Core\Tests\Providers\AbsFunctionDataProvider;
use Lsa\Xsl\Core\Tokenizer\Computing\XslTokenParser;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class AbsFunctionTest extends CommonMethods
{
    #[DataProviderExternal(AbsFunctionDataProvider::class, 'validDataProvider')]
    ...
    #[DataProviderExternal(AbsFunctionDataProvider::class, 'invalidDataProvider')]
