...
use Lsa\Xsl\Core\Tests\Providers\RoundFunctionDataProvider;
use Lsa\Xsl\Core\Tokenizer\Computing\XslTokenParser;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class RoundFunctionTest extends CommonMethods
{
    #[DataProviderExternal(RoundFunctionDataProvider::class, 'validDataProvider')]
    ...
    #[DataProviderExternal(RoundFunctionDataProvider::class, 'invalidDataProvider')]
