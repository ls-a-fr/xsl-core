...
use Lsa\Xsl\Core\Tests\Providers\MaxFunctionDataProvider;
use Lsa\Xsl\Core\Tokenizer\Computing\XslTokenParser;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class MaxFunctionTest extends CommonMethods
{
    #[DataProviderExternal(MaxFunctionDataProvider::class, 'validDataProvider')]
    ...
    #[DataProviderExternal(MaxFunctionDataProvider::class, 'invalidDataProvider')]
