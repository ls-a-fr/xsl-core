...
use Lsa\Xsl\Core\Tests\Providers\FloorFunctionDataProvider;
use Lsa\Xsl\Core\Tokenizer\Computing\XslTokenParser;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class FloorFunctionTest extends CommonMethods
{
    #[DataProviderExternal(FloorFunctionDataProvider::class, 'validDataProvider')]
    ...
    #[DataProviderExternal(FloorFunctionDataProvider::class, 'invalidDataProvider')]
