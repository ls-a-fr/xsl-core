...
use Lsa\Xsl\Core\Tests\Providers\PageNumberTreatmentDataProvider;
use Lsa\Xsl\Core\Validation\Properties\PageNumberTreatment;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class PageNumberTreatmentTest extends CommonMethods
{
    private string $attributeName = 'page-number-treatment';

    private string $typeClassName = PageNumberTreatment::class;
    ...
    #[DataProviderExternal(PageNumberTreatmentDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(PageNumberTreatmentDataProvider::class, 'invalidDataProvider')]
