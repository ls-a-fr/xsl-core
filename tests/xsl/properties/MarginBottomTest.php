...
use Lsa\Xsl\Core\Tests\Providers\MarginDataProvider;
use Lsa\Xsl\Core\Validation\Properties\MarginBottom;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class MarginBottomTest extends CommonMethods
{
    private string $attributeName = 'margin-bottom';

    private string $typeClassName = MarginBottom::class;
    ...
    #[DataProviderExternal(MarginDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(MarginDataProvider::class, 'invalidDataProvider')]
