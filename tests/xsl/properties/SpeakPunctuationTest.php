...
use Lsa\Xsl\Core\Tests\Providers\SpeakPunctuationDataProvider;
use Lsa\Xsl\Core\Validation\Properties\SpeakPunctuation;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class SpeakPunctuationTest extends CommonMethods
{
    private string $attributeName = 'speak-punctuation';

    private string $typeClassName = SpeakPunctuation::class;
    ...
    #[DataProviderExternal(SpeakPunctuationDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(SpeakPunctuationDataProvider::class, 'invalidDataProvider')]
