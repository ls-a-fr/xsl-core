...
final class AllowedWidthScaleTest extends CommonMethods
{
    private string $attributeName = 'allowed-width-scale';

    private string $typeClassName = AllowedWidthScale::class;
