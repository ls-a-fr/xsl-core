...
use Lsa\Xsl\Core\Tests\Providers\ElevationDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Elevation;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class ElevationTest extends CommonMethods
{
    private string $attributeName = 'elevation';

    private string $typeClassName = Elevation::class;
    ...
    #[DataProviderExternal(ElevationDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(ElevationDataProvider::class, 'invalidDataProvider')]
