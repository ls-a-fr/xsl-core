...
use Lsa\Xsl\Core\Tests\Providers\BorderCollapseDataProvider;
use Lsa\Xsl\Core\Validation\Properties\BorderCollapse;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class BorderCollapseTest extends CommonMethods
{
    private string $attributeName = 'border-collapse';

    private string $typeClassName = BorderCollapse::class;
    ...
    #[DataProviderExternal(BorderCollapseDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(BorderCollapseDataProvider::class, 'invalidDataProvider')]
