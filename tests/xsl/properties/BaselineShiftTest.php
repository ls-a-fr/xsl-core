...
use Lsa\Xsl\Core\Tests\Providers\BaselineShiftDataProvider;
use Lsa\Xsl\Core\Validation\Properties\BaselineShift;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class BaselineShiftTest extends CommonMethods
{
    private string $attributeName = 'baseline-shift';

    private string $typeClassName = BaselineShift::class;
    ...
    #[DataProviderExternal(BaselineShiftDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(BaselineShiftDataProvider::class, 'invalidDataProvider')]
