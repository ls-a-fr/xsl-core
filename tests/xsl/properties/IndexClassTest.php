...
use Lsa\Xsl\Core\Tests\Providers\StringDataProvider;
use Lsa\Xsl\Core\Validation\Properties\IndexClass;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class IndexClassTest extends CommonMethods
{
    private string $attributeName = 'index-class';

    private string $typeClassName = IndexClass::class;
    ...
    #[DataProviderExternal(StringDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(StringDataProvider::class, 'invalidDataProvider')]
