...
use Lsa\Xsl\Core\Tests\Providers\ColumnGapDataProvider;
use Lsa\Xsl\Core\Validation\Properties\ColumnGap;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class ColumnGapTest extends CommonMethods
{
    private string $attributeName = 'column-gap';

    private string $typeClassName = ColumnGap::class;
    ...
    #[DataProviderExternal(ColumnGapDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(ColumnGapDataProvider::class, 'invalidDataProvider')]
