...
use Lsa\Xsl\Core\Tests\Providers\FontDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Font;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class FontTest extends CommonMethods
{
    private string $attributeName = 'font';

    private string $typeClassName = Font::class;
    ...
    #[DataProviderExternal(FontDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(FontDataProvider::class, 'invalidDataProvider')]
