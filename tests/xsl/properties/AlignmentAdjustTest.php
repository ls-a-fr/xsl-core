...
use Lsa\Xsl\Core\Tests\Providers\AlignmentAdjustDataProvider;
use Lsa\Xsl\Core\Validation\Properties\AlignmentAdjust;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class AlignmentAdjustTest extends CommonMethods
{
    private string $attributeName = 'alignment-adjust';

    private string $typeClassName = AlignmentAdjust::class;
    ...
    #[DataProviderExternal(AlignmentAdjustDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(AlignmentAdjustDataProvider::class, 'invalidDataProvider')]
