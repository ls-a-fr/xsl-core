...
use Lsa\Xsl\Core\Tests\Providers\TopDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Top;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class TopTest extends CommonMethods
{
    private string $attributeName = 'top';

    private string $typeClassName = Top::class;
    ...
    #[DataProviderExternal(TopDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(TopDataProvider::class, 'invalidDataProvider')]
