...
final class MergeSequentialPageNumbersTest extends CommonMethods
{
    private string $attributeName = 'merge-sequential-page-numbers';

    private string $typeClassName = MergeSequentialPageNumbers::class;
