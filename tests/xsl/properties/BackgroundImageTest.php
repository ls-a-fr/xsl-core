...
use Lsa\Xsl\Core\Tests\Providers\BackgroundImageDataProvider;
use Lsa\Xsl\Core\Validation\Properties\BackgroundImage;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class BackgroundImageTest extends CommonMethods
{
    private string $attributeName = 'background-image';

    private string $typeClassName = BackgroundImage::class;
    ...
    #[DataProviderExternal(BackgroundImageDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(BackgroundImageDataProvider::class, 'invalidDataProvider')]
