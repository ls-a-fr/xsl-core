...
use Lsa\Xsl\Core\Tests\Providers\LeftDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Left;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class LeftTest extends CommonMethods
{
    private string $attributeName = 'left';

    private string $typeClassName = Left::class;
    ...
    #[DataProviderExternal(LeftDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(LeftDataProvider::class, 'invalidDataProvider')]
