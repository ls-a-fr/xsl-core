...
use Lsa\Xsl\Core\Validation\Properties\BorderTopWidth;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class BorderTopWidthTest extends CommonMethods
{
    private string $attributeName = 'border-top-width';

    private string $typeClassName = BorderTopWidth::class;
