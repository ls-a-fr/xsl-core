...
final class ProvisionalLabelSeparationTest extends CommonMethods
{
    private string $attributeName = 'provisional-label-separation';

    private string $typeClassName = ProvisionalLabelSeparation::class;
