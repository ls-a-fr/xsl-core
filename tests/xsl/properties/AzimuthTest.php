...
use Lsa\Xsl\Core\Tests\Providers\AzimuthDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Azimuth;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class AzimuthTest extends CommonMethods
{
    private string $attributeName = 'azimuth';

    private string $typeClassName = Azimuth::class;
    ...
    #[DataProviderExternal(AzimuthDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(AzimuthDataProvider::class, 'invalidDataProvider')]
