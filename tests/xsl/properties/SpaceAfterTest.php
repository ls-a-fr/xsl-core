...
use Lsa\Xsl\Core\Tests\Providers\SpaceAfterBeforeDataProvider;
use Lsa\Xsl\Core\Validation\Properties\SpaceAfter;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class SpaceAfterTest extends CommonMethods
{
    private string $attributeName = 'space-after';

    private string $typeClassName = SpaceAfter::class;
    ...
    #[DataProviderExternal(SpaceAfterBeforeDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(SpaceAfterBeforeDataProvider::class, 'invalidDataProvider')]
