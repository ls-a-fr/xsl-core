...
use Lsa\Xsl\Core\Tests\Providers\RichnessDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Richness;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class RichnessTest extends CommonMethods
{
    private string $attributeName = 'richness';

    private string $typeClassName = Richness::class;
    ...
    #[DataProviderExternal(RichnessDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(RichnessDataProvider::class, 'invalidDataProvider')]
