...
use Lsa\Xsl\Core\Tests\Providers\ForcePageCountDataProvider;
use Lsa\Xsl\Core\Validation\Properties\ForcePageCount;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class ForcePageCountTest extends CommonMethods
{
    private string $attributeName = 'force-page-count';

    private string $typeClassName = ForcePageCount::class;
    ...
    #[DataProviderExternal(ForcePageCountDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(ForcePageCountDataProvider::class, 'invalidDataProvider')]
