...
use Lsa\Xsl\Core\Tests\Providers\VerticalAlignDataProvider;
use Lsa\Xsl\Core\Validation\Properties\VerticalAlign;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class VerticalAlignTest extends CommonMethods
{
    private string $attributeName = 'vertical-align';

    private string $typeClassName = VerticalAlign::class;
    ...
    #[DataProviderExternal(VerticalAlignDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(VerticalAlignDataProvider::class, 'invalidDataProvider')]
