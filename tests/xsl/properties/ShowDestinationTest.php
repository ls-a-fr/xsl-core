...
use Lsa\Xsl\Core\Tests\Providers\ShowDestinationDataProvider;
use Lsa\Xsl\Core\Validation\Properties\ShowDestination;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class ShowDestinationTest extends CommonMethods
{
    private string $attributeName = 'show-destination';

    private string $typeClassName = ShowDestination::class;
    ...
    #[DataProviderExternal(ShowDestinationDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(ShowDestinationDataProvider::class, 'invalidDataProvider')]
