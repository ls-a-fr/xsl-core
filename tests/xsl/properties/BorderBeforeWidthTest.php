...
use Lsa\Xsl\Core\Tests\Providers\BorderRelativeWidthDataProvider;
use Lsa\Xsl\Core\Validation\Properties\BorderBeforeWidth;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class BorderBeforeWidthTest extends CommonMethods
{
    private string $attributeName = 'border-before-width';

    private string $typeClassName = BorderBeforeWidth::class;
    ...
    #[DataProviderExternal(BorderRelativeWidthDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(BorderRelativeWidthDataProvider::class, 'invalidDataProvider')]
