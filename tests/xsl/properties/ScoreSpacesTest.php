...
use Lsa\Xsl\Core\Tests\Providers\ScoreSpacesDataProvider;
use Lsa\Xsl\Core\Validation\Properties\ScoreSpaces;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class ScoreSpacesTest extends CommonMethods
{
    private string $attributeName = 'score-spaces';

    private string $typeClassName = ScoreSpaces::class;
    ...
    #[DataProviderExternal(ScoreSpacesDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(ScoreSpacesDataProvider::class, 'invalidDataProvider')]
