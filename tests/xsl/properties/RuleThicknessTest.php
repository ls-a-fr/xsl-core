...
use Lsa\Xsl\Core\Tests\Providers\RuleThicknessDataProvider;
use Lsa\Xsl\Core\Validation\Properties\RuleThickness;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class RuleThicknessTest extends CommonMethods
{
    private string $attributeName = 'rule-thickness';

    private string $typeClassName = RuleThickness::class;
    ...
    #[DataProviderExternal(RuleThicknessDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(RuleThicknessDataProvider::class, 'invalidDataProvider')]
