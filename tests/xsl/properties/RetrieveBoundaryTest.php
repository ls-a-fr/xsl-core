...
use Lsa\Xsl\Core\Tests\Providers\RetrieveBoundaryDataProvider;
use Lsa\Xsl\Core\Validation\Properties\RetrieveBoundary;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class RetrieveBoundaryTest extends CommonMethods
{
    private string $attributeName = 'retrieve-boundary';

    private string $typeClassName = RetrieveBoundary::class;
    ...
    #[DataProviderExternal(RetrieveBoundaryDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(RetrieveBoundaryDataProvider::class, 'invalidDataProvider')]
