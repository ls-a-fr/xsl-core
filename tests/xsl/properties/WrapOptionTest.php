...
use Lsa\Xsl\Core\Tests\Providers\WrapOptionDataProvider;
use Lsa\Xsl\Core\Validation\Properties\WrapOption;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class WrapOptionTest extends CommonMethods
{
    private string $attributeName = 'wrap-option';

    private string $typeClassName = WrapOption::class;
    ...
    #[DataProviderExternal(WrapOptionDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(WrapOptionDataProvider::class, 'invalidDataProvider')]
