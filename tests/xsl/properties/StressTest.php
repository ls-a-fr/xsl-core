...
use Lsa\Xsl\Core\Tests\Providers\StressDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Stress;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class StressTest extends CommonMethods
{
    private string $attributeName = 'stress';

    private string $typeClassName = Stress::class;
    ...
    #[DataProviderExternal(StressDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(StressDataProvider::class, 'invalidDataProvider')]
