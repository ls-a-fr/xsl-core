...
use Lsa\Xsl\Core\Tests\Providers\CaptionSideDataProvider;
use Lsa\Xsl\Core\Validation\Properties\CaptionSide;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class CaptionSideTest extends CommonMethods
{
    private string $attributeName = 'caption-side';

    private string $typeClassName = CaptionSide::class;
    ...
    #[DataProviderExternal(CaptionSideDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(CaptionSideDataProvider::class, 'invalidDataProvider')]
