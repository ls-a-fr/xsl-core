...
final class RefIndexKeyTest extends CommonMethods
{
    private string $attributeName = 'ref-index-key';

    private string $typeClassName = RefIndexKey::class;
    ...
    private function mockType(mixed $value): array
    {
        ...
        $mock = (new Root())
            ->child((new PageSequence())
                ->attribute(new XmlAttribute('index-key', $value)));
