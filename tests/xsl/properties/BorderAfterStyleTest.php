...
final class BorderAfterStyleTest extends CommonMethods
{
    private string $attributeName = 'border-after-style';

    private string $typeClassName = BorderAfterStyle::class;
