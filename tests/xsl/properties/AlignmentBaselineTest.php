...
use Lsa\Xsl\Core\Tests\Providers\AlignmentBaselineDataProvider;
use Lsa\Xsl\Core\Validation\Properties\AlignmentBaseline;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class AlignmentBaselineTest extends CommonMethods
{
    private string $attributeName = 'alignment-baseline';

    private string $typeClassName = AlignmentBaseline::class;
    ...
    #[DataProviderExternal(AlignmentBaselineDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(AlignmentBaselineDataProvider::class, 'invalidDataProvider')]
