...
use Lsa\Xsl\Core\Tests\Providers\BorderMultiColorDataProvider;
use Lsa\Xsl\Core\Validation\Properties\BorderColor;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class BorderColorTest extends CommonMethods
{
    private string $attributeName = 'border-color';

    private string $typeClassName = BorderColor::class;
    ...
    #[DataProviderExternal(BorderMultiColorDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(BorderMultiColorDataProvider::class, 'invalidDataProvider')]
