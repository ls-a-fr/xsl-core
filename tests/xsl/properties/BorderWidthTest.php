...
use Lsa\Xsl\Core\Tests\Providers\BorderMultiWidthDataProvider;
use Lsa\Xsl\Core\Validation\Properties\BorderWidth;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class BorderWidthTest extends CommonMethods
{
    private string $attributeName = 'border-width';

    private string $typeClassName = BorderWidth::class;
    ...
    #[DataProviderExternal(BorderMultiWidthDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(BorderMultiWidthDataProvider::class, 'invalidDataProvider')]
