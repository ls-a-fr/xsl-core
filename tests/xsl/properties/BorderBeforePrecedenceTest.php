...
final class BorderBeforePrecedenceTest extends CommonMethods
{
    private string $attributeName = 'border-before-precedence';

    private string $typeClassName = BorderBeforePrecedence::class;
