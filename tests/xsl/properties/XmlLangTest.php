...
use Lsa\Xsl\Core\Tests\Providers\LanguageCountryDataProvider;
use Lsa\Xsl\Core\Validation\Properties\XmlLang;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class XmlLangTest extends CommonMethods
{
    private string $attributeName = 'xml:lang';

    private string $typeClassName = XmlLang::class;
    ...
    #[DataProviderExternal(LanguageCountryDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(LanguageCountryDataProvider::class, 'invalidDataProvider')]
