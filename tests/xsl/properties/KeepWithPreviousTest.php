...
use Lsa\Xsl\Core\Tests\Providers\KeepsDataProvider;
use Lsa\Xsl\Core\Validation\Properties\KeepWithPrevious;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class KeepWithPreviousTest extends CommonMethods
{
    private string $attributeName = 'keep-with-previous';

    private string $typeClassName = KeepWithPrevious::class;
    ...
    #[DataProviderExternal(KeepsDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(KeepsDataProvider::class, 'invalidDataProvider')]
