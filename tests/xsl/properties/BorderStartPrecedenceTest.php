...
final class BorderStartPrecedenceTest extends CommonMethods
{
    private string $attributeName = 'border-start-precedence';

    private string $typeClassName = BorderStartPrecedence::class;
