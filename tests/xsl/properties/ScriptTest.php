...
use Lsa\Xsl\Core\Tests\Providers\ScriptDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Script;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class ScriptTest extends CommonMethods
{
    private string $attributeName = 'script';

    private string $typeClassName = Script::class;
    ...
    #[DataProviderExternal(ScriptDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(ScriptDataProvider::class, 'invalidDataProvider')]
