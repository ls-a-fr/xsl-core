...
use Lsa\Xsl\Core\Tests\Providers\MinHeightWidthDataProvider;
use Lsa\Xsl\Core\Validation\Properties\MinWidth;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class MinWidthTest extends CommonMethods
{
    private string $attributeName = 'min-width';

    private string $typeClassName = MinWidth::class;
    ...
    #[DataProviderExternal(MinHeightWidthDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(MinHeightWidthDataProvider::class, 'invalidDataProvider')]
