...
use Lsa\Xsl\Core\Validation\Properties\BorderTopColor;
use Lsa\Xsl\Core\Validation\Types\BorderColorType;
use Lsa\Xsl\Core\Validation\Types\Functions\ColorRgbIccType;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class BorderTopColorTest extends CommonMethods
{
    private string $attributeName = 'border-top-color';

    private string $typeClassName = BorderTopColor::class;
    ...
    {
        [$color, $root, $parent] = $this->mockBorderColorType();
        $this->validValueWithContext($color, $root, $parent, $value);
    }
    ...
    {
        [$color, $root, $parent] = $this->mockBorderColorType();
        $this->invalidValueWithContext($color, $root, $parent, $value);
    }
