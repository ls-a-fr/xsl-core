...
use Lsa\Xsl\Core\Tests\Providers\TextIndentDataProvider;
use Lsa\Xsl\Core\Validation\Properties\TextIndent;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class TextIndentTest extends CommonMethods
{
    private string $attributeName = 'text-indent';

    private string $typeClassName = TextIndent::class;
    ...
    #[DataProviderExternal(TextIndentDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(TextIndentDataProvider::class, 'invalidDataProvider')]
