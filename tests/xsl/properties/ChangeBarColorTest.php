...
use Lsa\Xsl\Core\Tests\Providers\ChangeBarColorDataProvider;
use Lsa\Xsl\Core\Validation\Properties\ChangeBarColor;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class ChangeBarColorTest extends CommonMethods
{
    private string $attributeName = 'change-bar-color';

    private string $typeClassName = ChangeBarColor::class;
    ...
    #[DataProviderExternal(ChangeBarColorDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(ChangeBarColorDataProvider::class, 'invalidDataProvider')]
