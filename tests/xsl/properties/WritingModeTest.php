...
use Lsa\Xsl\Core\Tests\Providers\WritingModeDataProvider;
use Lsa\Xsl\Core\Validation\Properties\WritingMode;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class WritingModeTest extends CommonMethods
{
    private string $attributeName = 'writing-mode';

    private string $typeClassName = WritingMode::class;
    ...
    #[DataProviderExternal(WritingModeDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(WritingModeDataProvider::class, 'invalidDataProvider')]
