...
use Lsa\Xsl\Core\Tests\Providers\ScaleOptionDataProvider;
use Lsa\Xsl\Core\Validation\Properties\ScaleOption;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class ScaleOptionTest extends CommonMethods
{
    private string $attributeName = 'scale-option';

    private string $typeClassName = ScaleOption::class;
    ...
    #[DataProviderExternal(ScaleOptionDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(ScaleOptionDataProvider::class, 'invalidDataProvider')]
