...
use Lsa\Xsl\Core\Tests\Providers\DirectionDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Direction;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class DirectionTest extends CommonMethods
{
    private string $attributeName = 'direction';

    private string $typeClassName = Direction::class;
    ...
    #[DataProviderExternal(DirectionDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(DirectionDataProvider::class, 'invalidDataProvider')]
