...
use Lsa\Xsl\Core\Tests\Providers\RenderingIntentDataProvider;
use Lsa\Xsl\Core\Validation\Properties\RenderingIntent;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class RenderingIntentTest extends CommonMethods
{
    private string $attributeName = 'rendering-intent';

    private string $typeClassName = RenderingIntent::class;
    ...
    #[DataProviderExternal(RenderingIntentDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(RenderingIntentDataProvider::class, 'invalidDataProvider')]
