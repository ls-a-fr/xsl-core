...
use Lsa\Xsl\Core\Tests\Providers\SpeakDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Speak;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class SpeakTest extends CommonMethods
{
    private string $attributeName = 'speak';

    private string $typeClassName = Speak::class;
    ...
    #[DataProviderExternal(SpeakDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(SpeakDataProvider::class, 'invalidDataProvider')]
