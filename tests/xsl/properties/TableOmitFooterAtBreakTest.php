...
final class TableOmitFooterAtBreakTest extends CommonMethods
{
    private string $attributeName = 'table-omit-footer-at-break';

    private string $typeClassName = TableOmitFooterAtBreak::class;
