...
use Lsa\Xsl\Core\Validation\Properties\BorderRightStyle;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class BorderRightStyleTest extends CommonMethods
{
    private string $attributeName = 'border-right-style';

    private string $typeClassName = BorderRightStyle::class;
