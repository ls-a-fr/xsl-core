...
use Lsa\Xsl\Core\Tests\Providers\ProgressionDimensionDataProvider;
use Lsa\Xsl\Core\Validation\Properties\BlockProgressionDimension;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class BlockProgressionDimensionTest extends CommonMethods
{
    private string $attributeName = 'block-progression-dimension';

    private string $typeClassName = BlockProgressionDimension::class;
    ...
    #[DataProviderExternal(ProgressionDimensionDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(ProgressionDimensionDataProvider::class, 'invalidDataProvider')]
