...
use Lsa\Xsl\Core\Tests\Providers\SpeakHeaderDataProvider;
use Lsa\Xsl\Core\Validation\Properties\SpeakHeader;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class SpeakHeaderTest extends CommonMethods
{
    private string $attributeName = 'speak-header';

    private string $typeClassName = SpeakHeader::class;
    ...
    #[DataProviderExternal(SpeakHeaderDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(SpeakHeaderDataProvider::class, 'invalidDataProvider')]
