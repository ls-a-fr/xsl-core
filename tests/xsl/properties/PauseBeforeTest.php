...
use Lsa\Xsl\Core\Tests\Providers\PauseBeforeDataProvider;
use Lsa\Xsl\Core\Validation\Properties\PauseBefore;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class PauseBeforeTest extends CommonMethods
{
    private string $attributeName = 'pause-before';

    private string $typeClassName = PauseBefore::class;
    ...
    #[DataProviderExternal(PauseBeforeDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(PauseBeforeDataProvider::class, 'invalidDataProvider')]
