...
use Lsa\Xsl\Core\Tests\Providers\FontSizeAdjustDataProvider;
use Lsa\Xsl\Core\Validation\Properties\FontSizeAdjust;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class FontSizeAdjustTest extends CommonMethods
{
    private string $attributeName = 'font-size-adjust';

    private string $typeClassName = FontSizeAdjust::class;
    ...
    #[DataProviderExternal(FontSizeAdjustDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(FontSizeAdjustDataProvider::class, 'invalidDataProvider')]
