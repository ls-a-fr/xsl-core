...
use Lsa\Xsl\Core\Tests\Providers\RetrieveBoundaryWithinTableDataProvider;
use Lsa\Xsl\Core\Validation\Properties\RetrieveBoundaryWithinTable;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class RetrieveBoundaryWithinTableTest extends CommonMethods
{
    private string $attributeName = 'retrieve-boundary-within-table';

    private string $typeClassName = RetrieveBoundaryWithinTable::class;
    ...
    #[DataProviderExternal(RetrieveBoundaryWithinTableDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(RetrieveBoundaryWithinTableDataProvider::class, 'invalidDataProvider')]
