...
use Lsa\Xsl\Core\Tests\Providers\DisplayAlignDataProvider;
use Lsa\Xsl\Core\Validation\Properties\DisplayAlign;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class DisplayAlignTest extends CommonMethods
{
    private string $attributeName = 'display-align';

    private string $typeClassName = DisplayAlign::class;
    ...
    #[DataProviderExternal(DisplayAlignDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(DisplayAlignDataProvider::class, 'invalidDataProvider')]
