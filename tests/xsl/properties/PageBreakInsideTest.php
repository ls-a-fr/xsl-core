...
use Lsa\Xsl\Core\Tests\Providers\PageBreakInsideDataProvider;
use Lsa\Xsl\Core\Validation\Properties\PageBreakInside;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class PageBreakInsideTest extends CommonMethods
{
    private string $attributeName = 'page-break-inside';

    private string $typeClassName = PageBreakInside::class;
    ...
    #[DataProviderExternal(PageBreakInsideDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(PageBreakInsideDataProvider::class, 'invalidDataProvider')]
