...
use Lsa\Xsl\Core\Tests\Providers\LinefeedTreatmentDataProvider;
use Lsa\Xsl\Core\Validation\Properties\LinefeedTreatment;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class LinefeedTreatmentTest extends CommonMethods
{
    private string $attributeName = 'linefeed-treatment';

    private string $typeClassName = LinefeedTreatment::class;
    ...
    #[DataProviderExternal(LinefeedTreatmentDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(LinefeedTreatmentDataProvider::class, 'invalidDataProvider')]
