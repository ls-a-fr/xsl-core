...
use Lsa\Xsl\Core\Validation\Properties\BorderRightWidth;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class BorderRightWidthTest extends CommonMethods
{
    private string $attributeName = 'border-right-width';

    private string $typeClassName = BorderRightWidth::class;
