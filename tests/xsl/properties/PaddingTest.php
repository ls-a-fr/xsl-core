...
use Lsa\Xsl\Core\Tests\Providers\PaddingMultiDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Padding;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class PaddingTest extends CommonMethods
{
    private string $attributeName = 'padding';

    private string $typeClassName = Padding::class;
    ...
    #[DataProviderExternal(PaddingMultiDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(PaddingMultiDataProvider::class, 'invalidDataProvider')]
