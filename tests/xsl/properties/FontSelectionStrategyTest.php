...
use Lsa\Xsl\Core\Tests\Providers\FontSelectionStrategyDataProvider;
use Lsa\Xsl\Core\Validation\Properties\FontSelectionStrategy;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class FontSelectionStrategyTest extends CommonMethods
{
    private string $attributeName = 'font-selection-strategy';

    private string $typeClassName = FontSelectionStrategy::class;
    ...
    #[DataProviderExternal(FontSelectionStrategyDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(FontSelectionStrategyDataProvider::class, 'invalidDataProvider')]
