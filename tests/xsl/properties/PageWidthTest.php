...
use Lsa\Xsl\Core\Tests\Providers\PageHeightWidthDataProvider;
use Lsa\Xsl\Core\Validation\Properties\PageWidth;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class PageWidthTest extends CommonMethods
{
    private string $attributeName = 'page-width';

    private string $typeClassName = PageWidth::class;
    ...
    #[DataProviderExternal(PageHeightWidthDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(PageHeightWidthDataProvider::class, 'invalidDataProvider')]
