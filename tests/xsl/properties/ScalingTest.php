...
use Lsa\Xsl\Core\Tests\Providers\ScalingDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Scaling;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class ScalingTest extends CommonMethods
{
    private string $attributeName = 'scaling';

    private string $typeClassName = Scaling::class;
    ...
    #[DataProviderExternal(ScalingDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(ScalingDataProvider::class, 'invalidDataProvider')]
