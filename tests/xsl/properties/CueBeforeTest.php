...
use Lsa\Xsl\Core\Tests\Providers\CueBeforeDataProvider;
use Lsa\Xsl\Core\Validation\Properties\CueBefore;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class CueBeforeTest extends CommonMethods
{
    private string $attributeName = 'cue-before';

    private string $typeClassName = CueBefore::class;
    ...
    #[DataProviderExternal(CueBeforeDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(CueBeforeDataProvider::class, 'invalidDataProvider')]
