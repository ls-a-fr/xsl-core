...
use Lsa\Xsl\Core\Tests\Providers\TextAlignDataProvider;
use Lsa\Xsl\Core\Validation\Properties\TextAlign;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class TextAlignTest extends CommonMethods
{
    private string $attributeName = 'text-align';

    private string $typeClassName = TextAlign::class;
    ...
    #[DataProviderExternal(TextAlignDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(TextAlignDataProvider::class, 'invalidDataProvider')]
