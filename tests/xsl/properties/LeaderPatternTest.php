...
use Lsa\Xsl\Core\Tests\Providers\LeaderPatternDataProvider;
use Lsa\Xsl\Core\Validation\Properties\LeaderPattern;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class LeaderPatternTest extends CommonMethods
{
    private string $attributeName = 'leader-pattern';

    private string $typeClassName = LeaderPattern::class;
    ...
    #[DataProviderExternal(LeaderPatternDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(LeaderPatternDataProvider::class, 'invalidDataProvider')]
