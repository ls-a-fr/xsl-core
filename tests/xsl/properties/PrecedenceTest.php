...
use Lsa\Xsl\Core\Tests\Providers\PrecedenceDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Precedence;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class PrecedenceTest extends CommonMethods
{
    private string $attributeName = 'precedence';

    private string $typeClassName = Precedence::class;
    ...
    #[DataProviderExternal(PrecedenceDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(PrecedenceDataProvider::class, 'invalidDataProvider')]
