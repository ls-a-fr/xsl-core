...
use Lsa\Xsl\Core\Tests\Providers\PitchDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Pitch;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class PitchTest extends CommonMethods
{
    private string $attributeName = 'pitch';

    private string $typeClassName = Pitch::class;
    ...
    #[DataProviderExternal(PitchDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(PitchDataProvider::class, 'invalidDataProvider')]
