...
use Lsa\Xsl\Core\Tests\Providers\FloatDataProvider;
use Lsa\Xsl\Core\Validation\Properties\FloatProperty;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class FloatTest extends CommonMethods
{
    private string $attributeName = 'float';

    private string $typeClassName = FloatProperty::class;
    ...
    #[DataProviderExternal(FloatDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(FloatDataProvider::class, 'invalidDataProvider')]
