...
use Lsa\Xsl\Core\Tests\Providers\LeaderLengthDataProvider;
use Lsa\Xsl\Core\Validation\Properties\LeaderLength;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class LeaderLengthTest extends CommonMethods
{
    private string $attributeName = 'leader-length';

    private string $typeClassName = LeaderLength::class;
    ...
    #[DataProviderExternal(LeaderLengthDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(LeaderLengthDataProvider::class, 'invalidDataProvider')]
