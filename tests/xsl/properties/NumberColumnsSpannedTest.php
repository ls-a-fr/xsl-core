...
final class NumberColumnsSpannedTest extends CommonMethods
{
    private string $attributeName = 'number-columns-spanned';

    private string $typeClassName = NumberColumnsSpanned::class;
