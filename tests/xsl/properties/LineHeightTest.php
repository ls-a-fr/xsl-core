...
use Lsa\Xsl\Core\Tests\Providers\LineHeightDataProvider;
use Lsa\Xsl\Core\Validation\Properties\LineHeight;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class LineHeightTest extends CommonMethods
{
    private string $attributeName = 'line-height';

    private string $typeClassName = LineHeight::class;
    ...
    #[DataProviderExternal(LineHeightDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(LineHeightDataProvider::class, 'invalidDataProvider')]
