...
use Lsa\Xsl\Core\Tests\Providers\PitchRangeDataProvider;
use Lsa\Xsl\Core\Validation\Properties\PitchRange;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class PitchRangeTest extends CommonMethods
{
    private string $attributeName = 'pitch-range';

    private string $typeClassName = PitchRange::class;
    ...
    #[DataProviderExternal(PitchRangeDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(PitchRangeDataProvider::class, 'invalidDataProvider')]
