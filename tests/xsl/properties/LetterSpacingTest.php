...
use Lsa\Xsl\Core\Tests\Providers\LetterSpacingDataProvider;
use Lsa\Xsl\Core\Validation\Properties\LetterSpacing;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class LetterSpacingTest extends CommonMethods
{
    private string $attributeName = 'letter-spacing';

    private string $typeClassName = LetterSpacing::class;
    ...
    #[DataProviderExternal(LetterSpacingDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(LetterSpacingDataProvider::class, 'invalidDataProvider')]
