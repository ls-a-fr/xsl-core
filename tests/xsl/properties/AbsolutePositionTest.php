...
use Lsa\Xsl\Core\Tests\Providers\AbsolutePositionDataProvider;
use Lsa\Xsl\Core\Validation\Properties\AbsolutePosition;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class AbsolutePositionTest extends CommonMethods
{
    private string $attributeName = 'absolute-position';

    private string $typeClassName = AbsolutePosition::class;
    ...
    #[DataProviderExternal(AbsolutePositionDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(AbsolutePositionDataProvider::class, 'invalidDataProvider')]
