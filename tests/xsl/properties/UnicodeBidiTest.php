...
use Lsa\Xsl\Core\Tests\Providers\UnicodeBidiDataProvider;
use Lsa\Xsl\Core\Validation\Properties\UnicodeBidi;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class UnicodeBidiTest extends CommonMethods
{
    private string $attributeName = 'unicode-bidi';

    private string $typeClassName = UnicodeBidi::class;
    ...
    #[DataProviderExternal(UnicodeBidiDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(UnicodeBidiDataProvider::class, 'invalidDataProvider')]
