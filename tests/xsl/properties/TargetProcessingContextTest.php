...
use Lsa\Xsl\Core\Tests\Providers\TargetProcessingContextDataProvider;
use Lsa\Xsl\Core\Validation\Properties\TargetProcessingContext;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class TargetProcessingContextTest extends CommonMethods
{
    private string $attributeName = 'target-processing-context';

    private string $typeClassName = TargetProcessingContext::class;
    ...
    #[DataProviderExternal(TargetProcessingContextDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(TargetProcessingContextDataProvider::class, 'invalidDataProvider')]
