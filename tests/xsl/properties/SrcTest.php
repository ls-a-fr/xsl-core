...
use Lsa\Xsl\Core\Tests\Providers\SrcDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Source;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class SrcTest extends CommonMethods
{
    private string $attributeName = 'src';

    private string $typeClassName = Source::class;
    ...
    #[DataProviderExternal(SrcDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(SrcDataProvider::class, 'invalidDataProvider')]
