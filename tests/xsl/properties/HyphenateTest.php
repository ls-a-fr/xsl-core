...
use Lsa\Xsl\Core\Tests\Providers\HyphenateDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Hyphenate;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class HyphenateTest extends CommonMethods
{
    private string $attributeName = 'hyphenate';

    private string $typeClassName = Hyphenate::class;
    ...
    #[DataProviderExternal(HyphenateDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(HyphenateDataProvider::class, 'invalidDataProvider')]
