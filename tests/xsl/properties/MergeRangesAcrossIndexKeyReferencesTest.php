...
final class MergeRangesAcrossIndexKeyReferencesTest extends CommonMethods
{
    private string $attributeName = 'merge-ranges-across-index-key-references';

    private string $typeClassName = MergeRangesAcrossIndexKeyReferences::class;
