...
use Lsa\Xsl\Core\Tests\Providers\TargetStylesheetDataProvider;
use Lsa\Xsl\Core\Validation\Properties\TargetStylesheet;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class TargetStylesheetTest extends CommonMethods
{
    private string $attributeName = 'target-stylesheet';

    private string $typeClassName = TargetStylesheet::class;
    ...
    #[DataProviderExternal(TargetStylesheetDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(TargetStylesheetDataProvider::class, 'invalidDataProvider')]
