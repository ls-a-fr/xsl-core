...
use Lsa\Xsl\Core\Validation\Properties\BorderLeftWidth;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class BorderLeftWidthTest extends CommonMethods
{
    private string $attributeName = 'border-left-width';

    private string $typeClassName = BorderLeftWidth::class;
