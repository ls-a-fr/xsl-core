...
use Lsa\Xsl\Core\Tests\Providers\PagePositionDataProvider;
use Lsa\Xsl\Core\Validation\Properties\PagePosition;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class PagePositionTest extends CommonMethods
{
    private string $attributeName = 'page-position';

    private string $typeClassName = PagePosition::class;
    ...
    #[DataProviderExternal(PagePositionDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(PagePositionDataProvider::class, 'invalidDataProvider')]
