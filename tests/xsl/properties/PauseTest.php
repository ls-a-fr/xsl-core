...
use Lsa\Xsl\Core\Tests\Providers\PauseDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Pause;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class PauseTest extends CommonMethods
{
    private string $attributeName = 'pause';

    private string $typeClassName = Pause::class;
    ...
    #[DataProviderExternal(PauseDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(PauseDataProvider::class, 'invalidDataProvider')]
