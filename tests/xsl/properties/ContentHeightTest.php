...
use Lsa\Xsl\Core\Tests\Providers\ContentDataProvider;
use Lsa\Xsl\Core\Validation\Properties\ContentHeight;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class ContentHeightTest extends CommonMethods
{
    private string $attributeName = 'content-height';

    private string $typeClassName = ContentHeight::class;
    ...
    #[DataProviderExternal(ContentDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(ContentDataProvider::class, 'invalidDataProvider')]
