...
use Lsa\Xsl\Core\Tests\Providers\RelativeAlignDataProvider;
use Lsa\Xsl\Core\Validation\Properties\RelativeAlign;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class RelativeAlignTest extends CommonMethods
{
    private string $attributeName = 'relative-align';

    private string $typeClassName = RelativeAlign::class;
    ...
    #[DataProviderExternal(RelativeAlignDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(RelativeAlignDataProvider::class, 'invalidDataProvider')]
