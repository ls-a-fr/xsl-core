...
use Lsa\Xsl\Core\Tests\Providers\TextDecorationDataProvider;
use Lsa\Xsl\Core\Validation\Properties\TextDecoration;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class TextDecorationTest extends CommonMethods
{
    private string $attributeName = 'text-decoration';

    private string $typeClassName = TextDecoration::class;
    ...
    #[DataProviderExternal(TextDecorationDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(TextDecorationDataProvider::class, 'invalidDataProvider')]
