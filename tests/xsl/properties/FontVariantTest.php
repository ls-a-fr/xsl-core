...
use Lsa\Xsl\Core\Tests\Providers\FontVariantDataProvider;
use Lsa\Xsl\Core\Validation\Properties\FontVariant;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class FontVariantTest extends CommonMethods
{
    private string $attributeName = 'font-variant';

    private string $typeClassName = FontVariant::class;
    ...
    #[DataProviderExternal(FontVariantDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(FontVariantDataProvider::class, 'invalidDataProvider')]
