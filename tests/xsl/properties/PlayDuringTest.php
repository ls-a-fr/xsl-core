...
use Lsa\Xsl\Core\Tests\Providers\PlayDuringDataProvider;
use Lsa\Xsl\Core\Validation\Properties\PlayDuring;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class PlayDuringTest extends CommonMethods
{
    private string $attributeName = 'play-during';

    private string $typeClassName = PlayDuring::class;
    ...
    #[DataProviderExternal(PlayDuringDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(PlayDuringDataProvider::class, 'invalidDataProvider')]
