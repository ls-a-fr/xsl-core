...
use Lsa\Xsl\Core\Tests\Providers\SpanDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Span;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class SpanTest extends CommonMethods
{
    private string $attributeName = 'span';

    private string $typeClassName = Span::class;
    ...
    #[DataProviderExternal(SpanDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(SpanDataProvider::class, 'invalidDataProvider')]
