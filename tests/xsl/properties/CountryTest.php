...
use Lsa\Xsl\Core\Tests\Providers\CountryDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Country;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class CountryTest extends CommonMethods
{
    private string $attributeName = 'country';

    private string $typeClassName = Country::class;
    ...
    #[DataProviderExternal(CountryDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(CountryDataProvider::class, 'invalidDataProvider')]
