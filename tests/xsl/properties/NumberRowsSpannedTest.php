...
final class NumberRowsSpannedTest extends CommonMethods
{
    private string $attributeName = 'number-rows-spanned';

    private string $typeClassName = NumberRowsSpanned::class;
