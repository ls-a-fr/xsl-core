...
use Lsa\Xsl\Core\Tests\Providers\BackgroundRepeatDataProvider;
use Lsa\Xsl\Core\Validation\Properties\BackgroundRepeat;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class BackgroundRepeatTest extends CommonMethods
{
    private string $attributeName = 'background-repeat';

    private string $typeClassName = BackgroundRepeat::class;
    ...
    #[DataProviderExternal(BackgroundRepeatDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(BackgroundRepeatDataProvider::class, 'invalidDataProvider')]
