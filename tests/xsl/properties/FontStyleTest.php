...
use Lsa\Xsl\Core\Tests\Providers\FontStyleDataProvider;
use Lsa\Xsl\Core\Validation\Properties\FontStyle;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class FontStyleTest extends CommonMethods
{
    private string $attributeName = 'font-style';

    private string $typeClassName = FontStyle::class;
    ...
    #[DataProviderExternal(FontStyleDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(FontStyleDataProvider::class, 'invalidDataProvider')]
