...
use Lsa\Xsl\Core\Tests\Providers\MediaUsageDataProvider;
use Lsa\Xsl\Core\Validation\Properties\MediaUsage;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class MediaUsageTest extends CommonMethods
{
    private string $attributeName = 'media-usage';

    private string $typeClassName = MediaUsage::class;
    ...
    #[DataProviderExternal(MediaUsageDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(MediaUsageDataProvider::class, 'invalidDataProvider')]
