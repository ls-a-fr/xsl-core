...
use Lsa\Xsl\Core\Tests\Providers\CueDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Cue;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class CueTest extends CommonMethods
{
    private string $attributeName = 'cue';

    private string $typeClassName = Cue::class;
    ...
    #[DataProviderExternal(CueDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(CueDataProvider::class, 'invalidDataProvider')]
