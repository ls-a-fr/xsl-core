...
use Lsa\Xsl\Core\Tests\Providers\SpaceEndStartDataProvider;
use Lsa\Xsl\Core\Validation\Properties\SpaceEnd;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class SpaceEndTest extends CommonMethods
{
    private string $attributeName = 'space-end';

    private string $typeClassName = SpaceEnd::class;
    ...
    #[DataProviderExternal(SpaceEndStartDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(SpaceEndStartDataProvider::class, 'invalidDataProvider')]
