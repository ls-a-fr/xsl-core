...
use Lsa\Xsl\Core\Tests\Providers\RetrievePositionWithinTableDataProvider;
use Lsa\Xsl\Core\Validation\Properties\RetrievePositionWithinTable;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class RetrievePositionWithinTableTest extends CommonMethods
{
    private string $attributeName = 'retrieve-position-within-table';

    private string $typeClassName = RetrievePositionWithinTable::class;
    ...
    #[DataProviderExternal(RetrievePositionWithinTableDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(RetrievePositionWithinTableDataProvider::class, 'invalidDataProvider')]
