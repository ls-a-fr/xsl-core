...
use Lsa\Xsl\Core\Tests\Providers\RightDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Right;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class RightTest extends CommonMethods
{
    private string $attributeName = 'right';

    private string $typeClassName = Right::class;
    ...
    #[DataProviderExternal(RightDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(RightDataProvider::class, 'invalidDataProvider')]
