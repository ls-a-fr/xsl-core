...
use Lsa\Xsl\Core\Tests\Providers\BlankOrNotBlankDataProvider;
use Lsa\Xsl\Core\Validation\Properties\BlankOrNotBlank;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class BlankOrNotBlankTest extends CommonMethods
{
    private string $attributeName = 'blank-or-not-blank';

    private string $typeClassName = BlankOrNotBlank::class;
    ...
    #[DataProviderExternal(BlankOrNotBlankDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(BlankOrNotBlankDataProvider::class, 'invalidDataProvider')]
