...
use Lsa\Xsl\Core\Tests\Providers\BottomDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Bottom;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class BottomTest extends CommonMethods
{
    private string $attributeName = 'bottom';

    private string $typeClassName = Bottom::class;
    ...
    #[DataProviderExternal(BottomDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(BottomDataProvider::class, 'invalidDataProvider')]
