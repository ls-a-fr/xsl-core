...
final class BorderAfterWidthTest extends CommonMethods
{
    private string $attributeName = 'border-after-width';

    private string $typeClassName = BorderAfterWidth::class;
