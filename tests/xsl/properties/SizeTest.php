...
use Lsa\Xsl\Core\Tests\Providers\SizeDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Size;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class SizeTest extends CommonMethods
{
    private string $attributeName = 'size';

    private string $typeClassName = Size::class;
    ...
    #[DataProviderExternal(SizeDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(SizeDataProvider::class, 'invalidDataProvider')]
