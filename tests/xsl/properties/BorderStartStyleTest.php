...
final class BorderStartStyleTest extends CommonMethods
{
    private string $attributeName = 'border-start-style';

    private string $typeClassName = BorderStartStyle::class;
