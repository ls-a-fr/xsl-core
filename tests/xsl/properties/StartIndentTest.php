...
use Lsa\Xsl\Core\Tests\Providers\IndentDataProvider;
use Lsa\Xsl\Core\Validation\Properties\StartIndent;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class StartIndentTest extends CommonMethods
{
    private string $attributeName = 'start-indent';

    private string $typeClassName = StartIndent::class;
    ...
    #[DataProviderExternal(IndentDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(IndentDataProvider::class, 'invalidDataProvider')]
