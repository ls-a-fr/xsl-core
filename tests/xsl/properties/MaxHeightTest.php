...
use Lsa\Xsl\Core\Tests\Providers\MaxHeightWidthDataProvider;
use Lsa\Xsl\Core\Validation\Properties\MaxHeight;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class MaxHeightTest extends CommonMethods
{
    private string $attributeName = 'max-height';

    private string $typeClassName = MaxHeight::class;
    ...
    #[DataProviderExternal(MaxHeightWidthDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(MaxHeightWidthDataProvider::class, 'invalidDataProvider')]
