...
use Lsa\Xsl\Core\Tests\Providers\TextShadowDataProvider;
use Lsa\Xsl\Core\Validation\Properties\TextShadow;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class TextShadowTest extends CommonMethods
{
    private string $attributeName = 'text-shadow';

    private string $typeClassName = TextShadow::class;
    ...
    #[DataProviderExternal(TextShadowDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(TextShadowDataProvider::class, 'invalidDataProvider')]
