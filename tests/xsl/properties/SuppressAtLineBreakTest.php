...
use Lsa\Xsl\Core\Tests\Providers\SuppressAtLineBreakDataProvider;
use Lsa\Xsl\Core\Validation\Properties\SuppressAtLineBreak;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class SuppressAtLineBreakTest extends CommonMethods
{
    private string $attributeName = 'suppress-at-line-break';

    private string $typeClassName = SuppressAtLineBreak::class;
    ...
    #[DataProviderExternal(SuppressAtLineBreakDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(SuppressAtLineBreakDataProvider::class, 'invalidDataProvider')]
