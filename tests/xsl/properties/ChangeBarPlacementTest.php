...
use Lsa\Xsl\Core\Tests\Providers\ChangeBarPlacementDataProvider;
use Lsa\Xsl\Core\Validation\Properties\ChangeBarPlacement;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class ChangeBarPlacementTest extends CommonMethods
{
    private string $attributeName = 'change-bar-placement';

    private string $typeClassName = ChangeBarPlacement::class;
    ...
    #[DataProviderExternal(ChangeBarPlacementDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(ChangeBarPlacementDataProvider::class, 'invalidDataProvider')]
