...
final class TableOmitHeaderAtBreakTest extends CommonMethods
{
    private string $attributeName = 'table-omit-header-at-break';

    private string $typeClassName = TableOmitHeaderAtBreak::class;
