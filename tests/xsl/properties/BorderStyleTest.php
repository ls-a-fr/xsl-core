...
use Lsa\Xsl\Core\Tests\Providers\BorderMultiStyleDataProvider;
use Lsa\Xsl\Core\Validation\Properties\BorderStyle;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class BorderStyleTest extends CommonMethods
{
    private string $attributeName = 'border-style';

    private string $typeClassName = BorderStyle::class;
    ...
    #[DataProviderExternal(BorderMultiStyleDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(BorderMultiStyleDataProvider::class, 'invalidDataProvider')]
