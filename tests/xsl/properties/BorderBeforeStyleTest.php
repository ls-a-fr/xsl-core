...
final class BorderBeforeStyleTest extends CommonMethods
{
    private string $attributeName = 'border-before-style';

    private string $typeClassName = BorderBeforeStyle::class;
