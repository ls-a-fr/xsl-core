...
use Lsa\Xsl\Core\Tests\Providers\ReferenceOrientationDataProvider;
use Lsa\Xsl\Core\Validation\Properties\ReferenceOrientation;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class ReferenceOrientationTest extends CommonMethods
{
    private string $attributeName = 'reference-orientation';

    private string $typeClassName = ReferenceOrientation::class;
    ...
    #[DataProviderExternal(ReferenceOrientationDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(ReferenceOrientationDataProvider::class, 'invalidDataProvider')]
