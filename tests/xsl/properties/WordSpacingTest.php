...
use Lsa\Xsl\Core\Tests\Providers\WordSpacingDataProvider;
use Lsa\Xsl\Core\Validation\Properties\WordSpacing;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class WordSpacingTest extends CommonMethods
{
    private string $attributeName = 'word-spacing';

    private string $typeClassName = WordSpacing::class;
    ...
    #[DataProviderExternal(WordSpacingDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(WordSpacingDataProvider::class, 'invalidDataProvider')]
