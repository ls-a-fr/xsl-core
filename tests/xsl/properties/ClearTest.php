...
use Lsa\Xsl\Core\Tests\Providers\ClearDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Clear;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class ClearTest extends CommonMethods
{
    private string $attributeName = 'clear';

    private string $typeClassName = Clear::class;
    ...
    #[DataProviderExternal(ClearDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(ClearDataProvider::class, 'invalidDataProvider')]
