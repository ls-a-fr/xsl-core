...
final class BorderAfterColorTest extends CommonMethods
{
    private string $attributeName = 'border-after-color';

    private string $typeClassName = BorderAfterColor::class;
