...
use Lsa\Xsl\Core\Validation\Properties\BorderBottomStyle;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class BorderBottomStyleTest extends CommonMethods
{
    private string $attributeName = 'border-bottom-style';

    private string $typeClassName = BorderBottomStyle::class;
