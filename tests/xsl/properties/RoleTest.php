...
use Lsa\Xsl\Core\Tests\Providers\RoleDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Role;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class RoleTest extends CommonMethods
{
    private string $attributeName = 'role';

    private string $typeClassName = Role::class;
    ...
    #[DataProviderExternal(RoleDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(RoleDataProvider::class, 'invalidDataProvider')]
