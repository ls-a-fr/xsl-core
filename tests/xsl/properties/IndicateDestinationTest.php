...
final class IndicateDestinationTest extends CommonMethods
{
    private string $attributeName = 'indicate-destination';

    private string $typeClassName = IndicateDestination::class;
