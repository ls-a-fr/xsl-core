...
use Lsa\Xsl\Core\Validation\Properties\PauseAfter;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class PauseAfterTest extends CommonMethods
{
    private string $attributeName = 'pause-after';

    private string $typeClassName = PauseAfter::class;
