...
use Lsa\Xsl\Core\Tests\Providers\ColumnCountDataProvider;
use Lsa\Xsl\Core\Validation\Properties\ColumnCount;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class ColumnCountTest extends CommonMethods
{
    private string $attributeName = 'column-count';

    private string $typeClassName = ColumnCount::class;
    ...
    #[DataProviderExternal(ColumnCountDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(ColumnCountDataProvider::class, 'invalidDataProvider')]
