...
use Lsa\Xsl\Core\Tests\Providers\LastLineEndIndentDataProvider;
use Lsa\Xsl\Core\Validation\Properties\LastLineEndIndent;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class LastLineEndIndentTest extends CommonMethods
{
    private string $attributeName = 'last-line-end-indent';

    private string $typeClassName = LastLineEndIndent::class;
    ...
    #[DataProviderExternal(LastLineEndIndentDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(LastLineEndIndentDataProvider::class, 'invalidDataProvider')]
