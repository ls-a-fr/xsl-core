...
use Lsa\Xsl\Core\Tests\Providers\ExternalDestinationDataProvider;
use Lsa\Xsl\Core\Validation\Properties\ExternalDestination;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class ExternalDestinationTest extends CommonMethods
{
    private string $attributeName = 'external-destination';

    private string $typeClassName = ExternalDestination::class;
    ...
    #[DataProviderExternal(ExternalDestinationDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(ExternalDestinationDataProvider::class, 'invalidDataProvider')]
