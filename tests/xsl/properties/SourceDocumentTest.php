...
use Lsa\Xsl\Core\Tests\Providers\SourceDocumentDataProvider;
use Lsa\Xsl\Core\Validation\Properties\SourceDocument;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class SourceDocumentTest extends CommonMethods
{
    private string $attributeName = 'source-document';

    private string $typeClassName = SourceDocument::class;
    ...
    #[DataProviderExternal(SourceDocumentDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(SourceDocumentDataProvider::class, 'invalidDataProvider')]
