...
use Lsa\Xsl\Core\Tests\Providers\PaddingAbsoluteDataProvider;
use Lsa\Xsl\Core\Validation\Properties\PaddingBottom;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class PaddingBottomTest extends CommonMethods
{
    private string $attributeName = 'padding-bottom';

    private string $typeClassName = PaddingBottom::class;
    ...
    #[DataProviderExternal(PaddingAbsoluteDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(PaddingAbsoluteDataProvider::class, 'invalidDataProvider')]
