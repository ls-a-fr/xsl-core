...
use Lsa\Xsl\Core\Validation\Properties\BorderBottomColor;
use Lsa\Xsl\Core\Validation\Types\BorderColorType;
use Lsa\Xsl\Core\Validation\Types\Functions\ColorRgbIccType;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class BorderBottomColorTest extends CommonMethods
{
    private string $attributeName = 'border-bottom-color';

    private string $typeClassName = BorderBottomColor::class;
