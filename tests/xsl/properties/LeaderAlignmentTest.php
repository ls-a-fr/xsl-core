...
use Lsa\Xsl\Core\Tests\Providers\LeaderAlignmentDataProvider;
use Lsa\Xsl\Core\Validation\Properties\LeaderAlignment;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class LeaderAlignmentTest extends CommonMethods
{
    private string $attributeName = 'leader-alignment';

    private string $typeClassName = LeaderAlignment::class;
    ...
    #[DataProviderExternal(LeaderAlignmentDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(LeaderAlignmentDataProvider::class, 'invalidDataProvider')]
