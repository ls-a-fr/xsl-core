...
use Lsa\Xsl\Core\Tests\Providers\PageCitationStrategyDataProvider;
use Lsa\Xsl\Core\Validation\Properties\PageCitationStrategy;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class PageCitationStrategyTest extends CommonMethods
{
    private string $attributeName = 'page-citation-strategy';

    private string $typeClassName = PageCitationStrategy::class;
    ...
    #[DataProviderExternal(PageCitationStrategyDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(PageCitationStrategyDataProvider::class, 'invalidDataProvider')]
