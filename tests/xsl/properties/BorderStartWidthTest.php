...
final class BorderStartWidthTest extends CommonMethods
{
    private string $attributeName = 'border-start-width';

    private string $typeClassName = BorderStartWidth::class;
