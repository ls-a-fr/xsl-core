...
use Lsa\Xsl\Core\Tests\Providers\PaddingRelativeDataProvider;
use Lsa\Xsl\Core\Validation\Properties\PaddingBefore;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class PaddingBeforeTest extends CommonMethods
{
    private string $attributeName = 'padding-before';

    private string $typeClassName = PaddingBefore::class;
    ...
    #[DataProviderExternal(PaddingRelativeDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(PaddingRelativeDataProvider::class, 'invalidDataProvider')]
