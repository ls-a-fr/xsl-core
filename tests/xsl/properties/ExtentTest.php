...
use Lsa\Xsl\Core\Tests\Providers\ExtentDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Extent;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class ExtentTest extends CommonMethods
{
    private string $attributeName = 'extent';

    private string $typeClassName = Extent::class;
    ...
    #[DataProviderExternal(ExtentDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(ExtentDataProvider::class, 'invalidDataProvider')]
