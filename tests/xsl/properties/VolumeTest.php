...
use Lsa\Xsl\Core\Tests\Providers\VolumeDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Volume;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class VolumeTest extends CommonMethods
{
    private string $attributeName = 'volume';

    private string $typeClassName = Volume::class;
    ...
    #[DataProviderExternal(VolumeDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(VolumeDataProvider::class, 'invalidDataProvider')]
