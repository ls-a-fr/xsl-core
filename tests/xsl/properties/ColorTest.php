...
use Lsa\Xsl\Core\Tests\Providers\ColorDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Color;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class ColorTest extends CommonMethods
{
    private string $attributeName = 'color';

    private string $typeClassName = Color::class;
    ...
    #[DataProviderExternal(ColorDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(ColorDataProvider::class, 'invalidDataProvider')]
