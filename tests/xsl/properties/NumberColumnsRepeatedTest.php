...
use Lsa\Xsl\Core\Tests\Providers\NumberDataProvider;
use Lsa\Xsl\Core\Validation\Properties\NumberColumnsRepeated;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class NumberColumnsRepeatedTest extends CommonMethods
{
    private string $attributeName = 'number-columns-repeated';

    private string $typeClassName = NumberColumnsRepeated::class;
    ...
    #[DataProviderExternal(NumberDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(NumberDataProvider::class, 'invalidDataProvider')]
