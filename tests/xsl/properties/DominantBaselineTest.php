...
use Lsa\Xsl\Core\Tests\Providers\DominantBaselineDataProvider;
use Lsa\Xsl\Core\Validation\Properties\DominantBaseline;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class DominantBaselineTest extends CommonMethods
{
    private string $attributeName = 'dominant-baseline';

    private string $typeClassName = DominantBaseline::class;
    ...
    #[DataProviderExternal(DominantBaselineDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(DominantBaselineDataProvider::class, 'invalidDataProvider')]
