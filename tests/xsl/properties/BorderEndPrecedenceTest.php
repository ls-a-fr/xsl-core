...
final class BorderEndPrecedenceTest extends CommonMethods
{
    private string $attributeName = 'border-end-precedence';

    private string $typeClassName = BorderEndPrecedence::class;
