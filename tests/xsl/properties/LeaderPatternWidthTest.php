...
use Lsa\Xsl\Core\Tests\Providers\LeaderPatternWidthDataProvider;
use Lsa\Xsl\Core\Validation\Properties\LeaderPatternWidth;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class LeaderPatternWidthTest extends CommonMethods
{
    private string $attributeName = 'leader-pattern-width';

    private string $typeClassName = LeaderPatternWidth::class;
    ...
    #[DataProviderExternal(LeaderPatternWidthDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(LeaderPatternWidthDataProvider::class, 'invalidDataProvider')]
