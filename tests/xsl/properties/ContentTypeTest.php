...
use Lsa\Xsl\Core\Tests\Providers\ContentTypeDataProvider;
use Lsa\Xsl\Core\Validation\Properties\ContentType;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class ContentTypeTest extends CommonMethods
{
    private string $attributeName = 'content-type';

    private string $typeClassName = ContentType::class;
    ...
    #[DataProviderExternal(ContentTypeDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(ContentTypeDataProvider::class, 'invalidDataProvider')]
