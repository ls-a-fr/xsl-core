...
final class HyphenationPushCharacterCountTest extends CommonMethods
{
    private string $attributeName = 'hyphenation-push-character-count';

    private string $typeClassName = HyphenationPushCharacterCount::class;
