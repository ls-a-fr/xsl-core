...
use Lsa\Xsl\Core\Tests\Providers\ClipDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Clip;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class ClipTest extends CommonMethods
{
    private string $attributeName = 'clip';

    private string $typeClassName = Clip::class;
    ...
    #[DataProviderExternal(ClipDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(ClipDataProvider::class, 'invalidDataProvider')]
