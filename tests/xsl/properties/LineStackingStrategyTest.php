...
use Lsa\Xsl\Core\Tests\Providers\LineStackingStrategyDataProvider;
use Lsa\Xsl\Core\Validation\Properties\LineStackingStrategy;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class LineStackingStrategyTest extends CommonMethods
{
    private string $attributeName = 'line-stacking-strategy';

    private string $typeClassName = LineStackingStrategy::class;
    ...
    #[DataProviderExternal(LineStackingStrategyDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(LineStackingStrategyDataProvider::class, 'invalidDataProvider')]
