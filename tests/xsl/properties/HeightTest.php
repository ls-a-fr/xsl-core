...
use Lsa\Xsl\Core\Tests\Providers\HeightWidthDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Height;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class HeightTest extends CommonMethods
{
    private string $attributeName = 'height';

    private string $typeClassName = Height::class;
    ...
    #[DataProviderExternal(HeightWidthDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(HeightWidthDataProvider::class, 'invalidDataProvider')]
