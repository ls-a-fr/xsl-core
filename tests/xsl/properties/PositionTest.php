...
use Lsa\Xsl\Core\Tests\Providers\PositionDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Position;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class PositionTest extends CommonMethods
{
    private string $attributeName = 'position';

    private string $typeClassName = Position::class;
    ...
    #[DataProviderExternal(PositionDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(PositionDataProvider::class, 'invalidDataProvider')]
