...
use Lsa\Xsl\Core\Tests\Providers\MaximumRepeatsDataProvider;
use Lsa\Xsl\Core\Validation\Properties\MaximumRepeats;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class MaximumRepeatsTest extends CommonMethods
{
    private string $attributeName = 'maximum-repeats';

    private string $typeClassName = MaximumRepeats::class;
    ...
    #[DataProviderExternal(MaximumRepeatsDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(MaximumRepeatsDataProvider::class, 'invalidDataProvider')]
