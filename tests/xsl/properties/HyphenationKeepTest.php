...
use Lsa\Xsl\Core\Tests\Providers\HyphenationKeepDataProvider;
use Lsa\Xsl\Core\Validation\Properties\HyphenationKeep;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class HyphenationKeepTest extends CommonMethods
{
    private string $attributeName = 'hyphenation-keep';

    private string $typeClassName = HyphenationKeep::class;
    ...
    #[DataProviderExternal(HyphenationKeepDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(HyphenationKeepDataProvider::class, 'invalidDataProvider')]
