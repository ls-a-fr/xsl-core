...
use Lsa\Xsl\Core\Tests\Providers\PageBreakAfterBeforeDataProvider;
use Lsa\Xsl\Core\Validation\Properties\PageBreakAfter;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class PageBreakAfterTest extends CommonMethods
{
    private string $attributeName = 'page-break-after';

    private string $typeClassName = PageBreakAfter::class;
    ...
    #[DataProviderExternal(PageBreakAfterBeforeDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(PageBreakAfterBeforeDataProvider::class, 'invalidDataProvider')]
