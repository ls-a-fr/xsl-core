...
use Lsa\Xsl\Core\Tests\Providers\ActiveStateDataProvider;
use Lsa\Xsl\Core\Validation\Properties\ActiveState;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class ActiveStateTest extends CommonMethods
{
    private string $attributeName = 'active-state';

    private string $typeClassName = ActiveState::class;
    ...
    #[DataProviderExternal(ActiveStateDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(ActiveStateDataProvider::class, 'invalidDataProvider')]
