...
use Lsa\Xsl\Core\Tests\Providers\RelativePositionDataProvider;
use Lsa\Xsl\Core\Validation\Properties\RelativePosition;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class RelativePositionTest extends CommonMethods
{
    private string $attributeName = 'relative-position';

    private string $typeClassName = RelativePosition::class;
    ...
    #[DataProviderExternal(RelativePositionDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(RelativePositionDataProvider::class, 'invalidDataProvider')]
