...
use Lsa\Xsl\Core\Tests\Providers\ColumnWidthDataProvider;
use Lsa\Xsl\Core\Validation\Properties\ColumnWidth;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class ColumnWidthTest extends CommonMethods
{
    private string $attributeName = 'column-width';

    private string $typeClassName = ColumnWidth::class;
    ...
    #[DataProviderExternal(ColumnWidthDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(ColumnWidthDataProvider::class, 'invalidDataProvider')]
