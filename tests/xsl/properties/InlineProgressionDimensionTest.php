...
final class InlineProgressionDimensionTest extends CommonMethods
{
    private string $attributeName = 'inline-progression-dimension';

    private string $typeClassName = InlineProgressionDimension::class;
