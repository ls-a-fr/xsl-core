...
use Lsa\Xsl\Core\Validation\Properties\BorderTopStyle;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class BorderTopStyleTest extends CommonMethods
{
    private string $attributeName = 'border-top-style';

    private string $typeClassName = BorderTopStyle::class;
