...
use Lsa\Xsl\Core\Tests\Providers\TextTransformDataProvider;
use Lsa\Xsl\Core\Validation\Properties\TextTransform;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class TextTransformTest extends CommonMethods
{
    private string $attributeName = 'text-transform';

    private string $typeClassName = TextTransform::class;
    ...
    #[DataProviderExternal(TextTransformDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(TextTransformDataProvider::class, 'invalidDataProvider')]
