...
use Lsa\Xsl\Core\Tests\Providers\ChangeBarStyleDataProvider;
use Lsa\Xsl\Core\Validation\Properties\ChangeBarStyle;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class ChangeBarStyleTest extends CommonMethods
{
    private string $attributeName = 'change-bar-style';

    private string $typeClassName = ChangeBarStyle::class;
    ...
    #[DataProviderExternal(ChangeBarStyleDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(ChangeBarStyleDataProvider::class, 'invalidDataProvider')]
