...
use Lsa\Xsl\Core\Validation\Properties\BorderLeftStyle;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class BorderLeftStyleTest extends CommonMethods
{
    private string $attributeName = 'border-left-style';

    private string $typeClassName = BorderLeftStyle::class;
