...
use Lsa\Xsl\Core\Tests\Providers\SpeakNumeralDataProvider;
use Lsa\Xsl\Core\Validation\Properties\SpeakNumeral;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class SpeakNumeralTest extends CommonMethods
{
    private string $attributeName = 'speak-numeral';

    private string $typeClassName = SpeakNumeral::class;
    ...
    #[DataProviderExternal(SpeakNumeralDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(SpeakNumeralDataProvider::class, 'invalidDataProvider')]
