...
use Lsa\Xsl\Core\Tests\Providers\TextAltitudeDepthDataProvider;
use Lsa\Xsl\Core\Validation\Properties\TextDepth;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class TextDepthTest extends CommonMethods
{
    private string $attributeName = 'text-depth';

    private string $typeClassName = TextDepth::class;
    ...
    #[DataProviderExternal(TextAltitudeDepthDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(TextAltitudeDepthDataProvider::class, 'invalidDataProvider')]
