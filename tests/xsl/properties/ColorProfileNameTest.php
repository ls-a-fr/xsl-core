...
final class ColorProfileNameTest extends CommonMethods
{
    private string $attributeName = 'color-profile-name';

    private string $typeClassName = ColorProfileName::class;
