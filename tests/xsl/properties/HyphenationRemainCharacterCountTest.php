...
use Lsa\Xsl\Core\Tests\Providers\HyphenationCharacterCountDataProvider;
use Lsa\Xsl\Core\Validation\Properties\HyphenationRemainCharacterCount;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class HyphenationRemainCharacterCountTest extends CommonMethods
{
    private string $attributeName = 'hyphenation-remain-character-count';

    private string $typeClassName = HyphenationRemainCharacterCount::class;
    ...
    #[DataProviderExternal(HyphenationCharacterCountDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(HyphenationCharacterCountDataProvider::class, 'invalidDataProvider')]
