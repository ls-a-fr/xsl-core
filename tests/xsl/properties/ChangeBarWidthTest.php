...
use Lsa\Xsl\Core\Tests\Providers\BorderWidthDataProvider;
use Lsa\Xsl\Core\Validation\Properties\ChangeBarWidth;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class ChangeBarWidthTest extends CommonMethods
{
    private string $attributeName = 'change-bar-width';

    private string $typeClassName = ChangeBarWidth::class;
    ...
    #[DataProviderExternal(BorderWidthDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(BorderWidthDataProvider::class, 'invalidDataProvider')]
