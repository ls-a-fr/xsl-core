...
use Lsa\Xsl\Core\Tests\Providers\RetrievePositionDataProvider;
use Lsa\Xsl\Core\Validation\Properties\RetrievePosition;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class RetrievePositionTest extends CommonMethods
{
    private string $attributeName = 'retrieve-position';

    private string $typeClassName = RetrievePosition::class;
    ...
    #[DataProviderExternal(RetrievePositionDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(RetrievePositionDataProvider::class, 'invalidDataProvider')]
