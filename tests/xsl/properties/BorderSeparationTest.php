...
use Lsa\Xsl\Core\Tests\Providers\BorderSeparationDataProvider;
use Lsa\Xsl\Core\Validation\Properties\BorderSeparation;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class BorderSeparationTest extends CommonMethods
{
    private string $attributeName = 'border-separation';

    private string $typeClassName = BorderSeparation::class;
    ...
    #[DataProviderExternal(BorderSeparationDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(BorderSeparationDataProvider::class, 'invalidDataProvider')]
