...
use Lsa\Xsl\Core\Tests\Providers\AllowedScaleDataProvider;
use Lsa\Xsl\Core\Validation\Properties\AllowedHeightScale;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class AllowedHeightScaleTest extends CommonMethods
{
    private string $attributeName = 'allowed-height-scale';

    private string $typeClassName = AllowedHeightScale::class;
    ...
    #[DataProviderExternal(AllowedScaleDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(AllowedScaleDataProvider::class, 'invalidDataProvider')]
