...
use Lsa\Xsl\Core\Tests\Providers\BorderSpacingDataProvider;
use Lsa\Xsl\Core\Validation\Properties\BorderSpacing;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class BorderSpacingTest extends CommonMethods
{
    private string $attributeName = 'border-spacing';

    private string $typeClassName = BorderSpacing::class;
    ...
    #[DataProviderExternal(BorderSpacingDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(BorderSpacingDataProvider::class, 'invalidDataProvider')]
