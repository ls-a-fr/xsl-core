...
use Lsa\Xsl\Core\Tests\Providers\HyphenationLadderCountDataProvider;
use Lsa\Xsl\Core\Validation\Properties\HyphenationLadderCount;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class HyphenationLadderCountTest extends CommonMethods
{
    private string $attributeName = 'hyphenation-ladder-count';

    private string $typeClassName = HyphenationLadderCount::class;
    ...
    #[DataProviderExternal(HyphenationLadderCountDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(HyphenationLadderCountDataProvider::class, 'invalidDataProvider')]
