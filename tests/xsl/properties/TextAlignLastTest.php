...
use Lsa\Xsl\Core\Tests\Providers\TextAlignLastDataProvider;
use Lsa\Xsl\Core\Validation\Properties\TextAlignLast;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class TextAlignLastTest extends CommonMethods
{
    private string $attributeName = 'text-align-last';

    private string $typeClassName = TextAlignLast::class;
    ...
    #[DataProviderExternal(TextAlignLastDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(TextAlignLastDataProvider::class, 'invalidDataProvider')]
