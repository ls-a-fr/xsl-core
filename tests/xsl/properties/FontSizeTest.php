...
use Lsa\Xsl\Core\Tests\Providers\FontSizeDataProvider;
use Lsa\Xsl\Core\Validation\Properties\FontSize;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class FontSizeTest extends CommonMethods
{
    private string $attributeName = 'font-size';

    private string $typeClassName = FontSize::class;
    ...
    #[DataProviderExternal(FontSizeDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(FontSizeDataProvider::class, 'invalidDataProvider')]
