...
use Lsa\Xsl\Core\Validation\Properties\BorderLeftColor;
use Lsa\Xsl\Core\Validation\Types\BorderColorType;
use Lsa\Xsl\Core\Validation\Types\Functions\ColorRgbIccType;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class BorderLeftColorTest extends CommonMethods
{
    private string $attributeName = 'border-left-color';

    private string $typeClassName = BorderLeftColor::class;
