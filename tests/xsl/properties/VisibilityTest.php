...
use Lsa\Xsl\Core\Tests\Providers\VisibilityDataProvider;
use Lsa\Xsl\Core\Validation\Properties\Visibility;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class VisibilityTest extends CommonMethods
{
    private string $attributeName = 'visibility';

    private string $typeClassName = Visibility::class;
    ...
    #[DataProviderExternal(VisibilityDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(VisibilityDataProvider::class, 'invalidDataProvider')]
