...
use Lsa\Xsl\Core\Tests\Providers\VoiceFamilyDataProvider;
use Lsa\Xsl\Core\Validation\Properties\VoiceFamily;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class VoiceFamilyTest extends CommonMethods
{
    private string $attributeName = 'voice-family';

    private string $typeClassName = VoiceFamily::class;
    ...
    #[DataProviderExternal(VoiceFamilyDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(VoiceFamilyDataProvider::class, 'invalidDataProvider')]
