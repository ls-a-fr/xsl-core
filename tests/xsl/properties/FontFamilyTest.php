...
use Lsa\Xsl\Core\Tests\Providers\FontFamilyDataProvider;
use Lsa\Xsl\Core\Validation\Properties\FontFamily;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class FontFamilyTest extends CommonMethods
{
    private string $attributeName = 'font-family';

    private string $typeClassName = FontFamily::class;
    ...
    #[DataProviderExternal(FontFamilyDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(FontFamilyDataProvider::class, 'invalidDataProvider')]
