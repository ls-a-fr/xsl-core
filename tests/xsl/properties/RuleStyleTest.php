...
use Lsa\Xsl\Core\Tests\Providers\RuleStyleDataProvider;
use Lsa\Xsl\Core\Validation\Properties\RuleStyle;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class RuleStyleTest extends CommonMethods
{
    private string $attributeName = 'rule-style';

    private string $typeClassName = RuleStyle::class;
    ...
    #[DataProviderExternal(RuleStyleDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(RuleStyleDataProvider::class, 'invalidDataProvider')]
