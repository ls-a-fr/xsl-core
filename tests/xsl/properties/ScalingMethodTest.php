...
use Lsa\Xsl\Core\Tests\Providers\ScalingMethodDataProvider;
use Lsa\Xsl\Core\Validation\Properties\ScalingMethod;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class ScalingMethodTest extends CommonMethods
{
    private string $attributeName = 'scaling-method';

    private string $typeClassName = ScalingMethod::class;
    ...
    #[DataProviderExternal(ScalingMethodDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(ScalingMethodDataProvider::class, 'invalidDataProvider')]
