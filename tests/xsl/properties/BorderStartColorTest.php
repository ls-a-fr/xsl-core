...
final class BorderStartColorTest extends CommonMethods
{
    private string $attributeName = 'border-start-color';

    private string $typeClassName = BorderStartColor::class;
