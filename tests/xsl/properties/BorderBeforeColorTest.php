...
final class BorderBeforeColorTest extends CommonMethods
{
    private string $attributeName = 'border-before-color';

    private string $typeClassName = BorderBeforeColor::class;
