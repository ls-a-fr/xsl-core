...
use Lsa\Xsl\Core\Validation\Properties\BorderRightColor;
use Lsa\Xsl\Core\Validation\Types\BorderColorType;
use Lsa\Xsl\Core\Validation\Types\Functions\ColorRgbIccType;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class BorderRightColorTest extends CommonMethods
{
    private string $attributeName = 'border-right-color';

    private string $typeClassName = BorderRightColor::class;
