...
use Lsa\Xsl\Core\Tests\Providers\FontWeightDataProvider;
use Lsa\Xsl\Core\Validation\Properties\FontWeight;
use PHPUnit\Framework\Attributes\DataProviderExternal;

final class FontWeightTest extends CommonMethods
{
    private string $attributeName = 'font-weight';

    private string $typeClassName = FontWeight::class;
    ...
    #[DataProviderExternal(FontWeightDataProvider::class, 'validDataProvider')]
    public function test_validation_with_valid_values(mixed $value): void
    {
        $this->validValue($this->typeClassName, $value);
    }

    #[DataProviderExternal(FontWeightDataProvider::class, 'invalidDataProvider')]
